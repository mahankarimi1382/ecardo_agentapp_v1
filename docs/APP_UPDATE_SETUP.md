...
to the **merchant** and **agent** apps. The user app (`qunzo_agentapp_v1`)
...
```kotlin
namespace = "com.ecardo.merchant"          // was com.qunzo.agent
applicationId = "com.ecardo.merchant"      // was com.qunzo.agent
```
...
|-----------|--------------------------|----------------------------|
| User      | `app_updates_agent`       | `AppUpdateConfig.agent`     |
